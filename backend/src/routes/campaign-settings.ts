...
router.put('/:campaignId/settings/player-settings', async (req, res) => {
    try {
        ...
        logger.info('Player settings updated', { campaignId, updatedFields: Object.keys(playerSettings) });
...
router.put('/:campaignId/settings/customization', async (req, res) => {
    try {
        ...
        logger.info('Campaign customization settings updated', { campaignId, updatedFields: Object.keys(customization) });
