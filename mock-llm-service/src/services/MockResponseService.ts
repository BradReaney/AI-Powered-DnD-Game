...
export class MockResponseService {
   ...
   * Generate content based on task type
   */
  private async generateContentByTaskType(
  ...
  private generateCharacterResponse(): string {
    ...
    const className =
      classes[Math.floor(Math.random() * classes.length)] || "Fighter";
  ...
  private generateStoryResponse(): string {
    const storyTemplates = [
      ...
      'You find yourself in a mystical glade where the air shimmers with magical energy. A mysterious figure emerges from the shadows - it\'s Valdris the Enchanter, a human wizard whose robes seem to shift and change color with his mood. His eyes hold the wisdom of ages, and his staff pulses with contained power. "Greetings, seeker of arcane knowledge," he intones with a voice that seems to echo from another realm. "I have been waiting for one such as you to arrive."\n\nThe glade around you responds to his presence, with flowers blooming in impossible colors and the very ground beneath your feet glowing softly. Valdris gestures toward a floating crystal that hovers in the center of the clearing. "This crystal holds the key to understanding the ancient magic that flows through this land. But unlocking its secrets will require both courage and wisdom."',

      'As you navigate through the winding mountain paths, you come across a hidden cave entrance partially concealed by ancient vines. From within emerges Korgath the Mountain King, a formidable dwarf warrior whose armor gleams with the luster of mithril. His battle-scarred face tells of countless conflicts, yet his eyes hold a deep kindness. "Well met, traveler," he booms with a voice that echoes off the mountain walls. "Few dare to venture this high into the peaks."\n\nThe mountain air is crisp and thin, and you can see for miles in every direction. Korgath points toward a distant peak where ancient ruins are barely visible. "Those ruins hold the secrets of my ancestors. They built a great fortress there, but it was lost to time and the elements. Perhaps together we can uncover what remains of their legacy."',
    ];
...
**Critical Success!** Your ${skillName} mastery shines through, achieving results beyond normal expectations.`;
    ...
    const sampleLocations = [
      {
        ...
        type: "castle",
        description:
          "Ancient fortress perched on a rocky hill, its dark stone walls have withstood centuries of conflict",
        importance: "major",
      ...
      },
      {
        ...
        type: "wilderness",
        description:
          "Dense woodland shrouded in perpetual mist, home to ancient trees and mysterious creatures",
        importance: "moderate",
      ...
      },
      {
        ...
        type: "settlement",
        description:
          "Cozy tavern with warm hearth and friendly atmosphere, a popular gathering place for adventurers",
        importance: "minor",
  ...
  private generateGeneralResponse(
    ...
    let content =
      "The mystical realm unfolds before you, filled with endless possibilities and wondrous discoveries waiting to be made.";
