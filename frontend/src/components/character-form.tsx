  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>{character ? "Update your character details" : "Build your D&D character"}</CardDescription>
      </CardHeader>
      <CardContent>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        hitPoints: { ...formData.hitPoints, current: Number.parseInt(e.target.value) || 0 },
                      })
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        hitPoints: { ...formData.hitPoints, maximum: Number.parseInt(e.target.value) || 1 },
                      })
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({ ...formData, armorClass: Number.parseInt(e.target.value) || 10 })}
                  />
                </div>
              </div>
            </TabsContent>
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            stats: { ...formData.stats, [stat]: Number.parseInt(e.target.value) || 10 },
                          })
                        }
                        className="flex-1"
                      />
